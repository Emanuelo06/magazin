...
const Navbar = () => {
  return (
    <header 
    className="relative flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white text-sm py-3 dark:bg-black">
    ...
    <div id="hs-navbar-example" className="hidden hs-collapse overflow-hidden transition-all duration-300 basis-full grow sm:block" aria-labelledby="hs-navbar-example-collapse">
      <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5 text-white">
        <a className="font-medium  focus:outline-hidden" href="#">Despre Noi</a>
        <a className='font-medium focus:outline-hidden'  href="#">Galerie Foto</a>
        <a className='font-medium focus:outline-hidden' href="#">Contact</a>
        <a className="font-medium text-gray-600 hover:text-gray-400 focus:outline-hidden focus:text-gray-400 dark:text-neutral-400 dark:hover:text-neutral-500 dark:focus:text-neutral-500" href="#"></a>
      </div>
    </div>
  </nav>
</header>
